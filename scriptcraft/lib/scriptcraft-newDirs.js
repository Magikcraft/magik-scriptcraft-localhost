...
function __onEnable ( __engine, __plugin, __script ) {
  ...
  // This File, up 4 -> magik-scriptcraft < magik-scriptcraft-minecraft < scriptcraft < lib < scriptcraft.js
  // AutoLoads in the magik-scriptcraft folder directoy
  plugins.autoload( global, new File('../../../../','/magik-scriptcraft/plugins') );
